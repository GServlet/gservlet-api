...
public class HttpSessionListenerTest {
	...
	public void testEvents() throws Exception {
		...
		File script = new File(folder + "/listeners/" + "HttpSessionListener.groovy");
		AbstractSessionListener listener = (AbstractSessionListener) scriptManager.createObject(script);
