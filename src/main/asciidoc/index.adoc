...
Once your Java web server is installed and configured, you can put it to work. Five steps take you from writing your first Groovy servlet to running it. Using Maven and the default directory layout, these steps are as follows:
...
You just need this configuration below to leverage the GServlet API in your Spring Boot application. Your Groovy scripts must be created in the *_src/main/resources_* folder if your application is packaged as a jar. 
