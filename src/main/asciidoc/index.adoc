...
| _db.driver_ | true | the database driver class name

| _db.url_ | true | the database url

| _db.user_ |  true | the database user

| _db.password_ | true | the database password
 
| _db.minPoolSize_ | false | the database minimum pool size. The default value is 1

| _db.maxPoolSize_ | false | the database maximum pool size. The default value is 3
