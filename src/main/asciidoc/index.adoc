...
public class MyServletContextAttributeListener {
    ...
    public void attributeAdded() {
        System.out.println("attr : " + name + " added with value: " + value)
    }

    @Override
    public void attributeRemoved() {
        System.out.println("attr : " + name + " removed with value: " + value)
    }

    @Override
    public void attributeReplaced() {
        System.out.println("attr : " + name + " replaced with value: " + value)
    }
...
public class MyHttpSessionBindingListener {
    ...
    public void valueBound() {
        System.out.println("attr : " + name + " bounded with value: " + value)
    }

    public void valueUnbound() {
        System.out.println("attr : " + name + " unbounded with value: " + value)
    }
...
public class MyHttpSessionIdListener implements HttpSessionIdListener {
    ...
    public void sessionIdChanged(HttpSessionEvent event, String oldSessionId) {
        System.out.println("session id changed : "+oldSessionId);
    }
